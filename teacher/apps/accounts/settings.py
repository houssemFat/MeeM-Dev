class StudentAppSettings(object):
...
app_teacher_settings = StudentAppSettings('TEACHER_')
app_teacher_settings.__name__ = __name__
sys.modules[__name__] = app_teacher_settings
