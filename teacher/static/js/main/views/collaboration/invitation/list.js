define([
  ...
  'backbone',
  'app',
  'text!scripts/main/templates/collaboration/invitation/list.html',
  'text!scripts/main/templates/collaboration/typeahead.html',
  'scripts/main/views/collaboration/invitation/sentItem',
  'scripts/main/views/collaboration/invitation/recievedItem',
  ], function($, _, Backbone , App, 
        template,
        typeaheadTemplate, 
        SentItem, 
        RecievedItem ) {
  var SentInvitationListView =  Backbone.Marionette.CompositeView.extend({
        events : {
        ...
        */
        initialize: function(options){
            ...
            this.itemView = ( options.type == "sent" ) ? SentItem : RecievedItem ;
        },
        /**
        * 
        * @param {Object} collectionView
