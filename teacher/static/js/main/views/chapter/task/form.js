define(['jquery', 'underscore', 'backbone', 'modelbinding', 
    ...
    return Backbone.View.extend({
        ...
        render : function() {
            ...
            this.responseListView = new QuestionListView ({collection : new Collection(this.options.questions), $el : this.$el.find ('#quizz_responses')});
        ...
        success : function($source, model, response) {
            ...
            this.$buttonsTitles.html(commons.tr('update'));
