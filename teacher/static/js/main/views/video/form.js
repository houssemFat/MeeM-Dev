define(['jquery', 
        ...
        'text!scripts/main/templates/video/form.html',
        'app',
        'scripts/main/views/video/fileUploader',
        'scripts/main/views/video/document/list',
        'scripts/main/models/video/document',], function($, _, Backbone, ModelBinding, 
        CourseModel, template, App, FileUploader, DocumentListView, DocumentModel ) {
